...
function! s:CalendarBuildKeymap(dir, vyear, vmnth)
  ...
  nmap <buffer> <C-Left>  <Plug>CalendarGotoPrevMonth
  nmap <buffer> <C-Right> <Plug>CalendarGotoNextMonth
  nmap <buffer> <C-Up>    <Plug>CalendarGotoPrevYear
  nmap <buffer> <C-Down>  <Plug>CalendarGotoNextYear
endfunction
