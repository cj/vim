...
if version >= 700
  ...
  hi Pmenu guifg=#fffedc guibg=#303030 gui=underline
  hi PmenuSel guifg=#fffedc guibg=#404040 gui=underline
  "PmenuSbar
  "PmenuThumb
endif
...
exe 'hi LineNr         guifg=#B8B7A3 guibg='.s:dark_grey_blue  .' gui=none'
